      ...
      <div style={styles.blockedPage}>
        <div style={styles.blockedCard}>
          ...
          <p style={styles.blockedText}>
            To post listings on Evelyn Hone Market, you need to be approved as a seller first.
            This helps us ensure only verified Evelyn Hone students participate.
          </p>
          <div style={styles.steps}>
            ...
            <div style={styles.step}>
              ...
              <span>Submit your Student ID</span>
            </div>
            <div style={styles.step}>
          ...
          {user.student_id ? (
            <div style={styles.pendingBox}>
              ⏳ Your student ID <strong>{user.student_id}</strong> is pending approval. Please wait for admin to approve you.
            </div>
          ) : (
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.formHeader}>
          ...
          <p style={styles.subtitle}>Fill in the details below to post your item or service</p>
        </div>
        ...
        <div style={styles.btnRow}>
          ...
          <button style={styles.submitBtn} onClick={handleSubmit}>Post Listing</button>
        </div>
      </div>
    </div>
  )
...
const styles = {
  ...
  container: { maxWidth:'700px', margin:'0 auto', background:'white', borderRadius:'12px', padding:'2rem', boxShadow:'0 4px 15px rgba(0,0,0,0.08)' },
  formHeader: { marginBottom:'2rem', borderBottom:'2px solid #f0f0f0', paddingBottom:'1rem' },
  title: { color:'#1a1a2e', fontSize:'1.6rem', marginBottom:'0.3rem' },
  ...
  label: { display:'block', color:'#1a1a2e', fontWeight:'bold', marginBottom:'0.5rem', fontSize:'0.9rem' },
  input: { width:'100%', padding:'0.8rem 1rem', borderRadius:'8px', border:'2px solid #eee', fontSize:'1rem', boxSizing:'border-box', outline:'none', background:'#fafafa', color:'#1a1a2e' },
  textarea: { width:'100%', padding:'0.8rem 1rem', borderRadius:'8px', border:'2px solid #eee', fontSize:'1rem', boxSizing:'border-box', height:'120px', outline:'none', background:'#fafafa', resize:'vertical', color:'#1a1a2e' },
  imageUpload: { display:'flex', alignItems:'center', gap:'0.8rem', padding:'1.5rem', border:'2px dashed #ddd', borderRadius:'8px', cursor:'pointer', color:'#888', justifyContent:'center' },
  uploadIcon: { fontSize:'1.5rem' },
  previewGrid: { display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(100px, 1fr))', gap:'0.5rem', marginTop:'1rem' },
  ...
  cancelBtn: { flex:1, padding:'0.9rem', background:'white', color:'#1a1a2e', border:'2px solid #1a1a2e', borderRadius:'8px', cursor:'pointer', fontWeight:'bold', fontSize:'1rem' },
  submitBtn: { flex:2, padding:'0.9rem', background:'#e94560', color:'white', border:'none', borderRadius:'8px', cursor:'pointer', fontWeight:'bold', fontSize:'1rem' },
  blockedPage: { minHeight:'80vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'2rem', background:'#f5f5f5' },
  blockedCard: { background:'white', borderRadius:'12px', padding:'2.5rem', maxWidth:'500px', width:'100%', textAlign:'center', boxShadow:'0 4px 15px rgba(0,0,0,0.08)' },
  blockedIcon: { fontSize:'3.5rem', marginBottom:'1rem' },
  blockedTitle: { color:'#1a1a2e', marginBottom:'1rem' },
  blockedText: { color:'#666', lineHeight:'1.6', marginBottom:'1.5rem', fontSize:'0.95rem' },
